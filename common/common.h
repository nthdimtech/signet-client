...
#define LOGIN_KEY_SZ (AES_BLK_SIZE)
#define INIT_RAND_DATA_SZ (AES_BLK_SIZE * 3)
#define INITIALIZE_CMD_SIZE (AES_BLK_SIZE * 6)
...
#define CMD_PACKET_PAYLOAD_SIZE (BLK_SIZE + CMD_PACKET_HEADER_SIZE + RAW_HID_HEADER_SIZE)
